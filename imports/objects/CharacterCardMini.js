...
export default class CharacterCardMini extends React.Component{
    ...
    render() {
        return (
            <NavLink to='#' onClick={() => this.props.func(this.props.id, this.props.somehistory, this.props.campaign, this.props.character)} className='nav-item nav-link hoverBox'>
                <div className="objectCardMini grow" draggable="false">
